...
const RELATED_METRICS: Record<string, string[]> = {
  gdpGrowth: ['inflationRates', 'unemploymentRates', 'interestRates'],
  inflationRates: ['gdpGrowth', 'interestRates', 'cpiData'],
  interestRates: ['inflationRates', 'gdpGrowth', 'exchangeRate'],
  unemploymentRates: ['gdpGrowth', 'youthUnemployment', 'laborForceParticipation'],
  employmentRates: ['unemploymentRates', 'gdpGrowth', 'laborForceParticipation'],
  gdpPerCapitaPPP: ['gdpGrowth', 'lifeExpectancy', 'internetUsers'],
  cpiData: ['inflationRates', 'interestRates', 'exchangeRate'],
  populationGrowth: ['urbanPopulation', 'lifeExpectancy', 'gdpGrowth'],
  governmentDebt: ['budgetBalance', 'publicDebtService', 'gdpGrowth'],
  budgetBalance: ['governmentDebt', 'taxRevenue', 'governmentSpending'],
  taxRevenue: ['budgetBalance', 'governmentSpending', 'gdpPerCapitaPPP'],
  governmentSpending: ['budgetBalance', 'taxRevenue', 'governmentDebt'],
  publicDebtService: ['governmentDebt', 'interestRates', 'budgetBalance'],
  grossCapitalFormation: ['gdpGrowth', 'fdi', 'privateInvestment'],
  militaryExpenditure: ['governmentSpending', 'budgetBalance', 'gdpPerCapitaPPP'],
  tradeBalance: ['exports', 'imports', 'currentAccount'],
  currentAccount: ['tradeBalance', 'fdi', 'exchangeRate'],
  fdi: ['gdpGrowth', 'tradeOpenness', 'currentAccount'],
  exports: ['imports', 'tradeBalance', 'exchangeRate'],
  imports: ['exports', 'tradeBalance', 'exchangeRate'],
  exchangeRate: ['inflationRates', 'interestRates', 'currentAccount'],
  tradeOpenness: ['exports', 'imports', 'fdi'],
  tariffRate: ['tradeOpenness', 'imports', 'exports'],
  tourismReceipts: ['exports', 'gdpGrowth', 'exchangeRate'],
  reservesMonthsImports: ['imports', 'currentAccount', 'exchangeRate'],
  lifeExpectancy: ['healthcareExpenditure', 'gdpPerCapitaPPP', 'educationExpenditure'],
  povertyRate: ['gdpPerCapitaPPP', 'giniCoefficient', 'unemploymentRates'],
  giniCoefficient: ['povertyRate', 'gdpPerCapitaPPP', 'educationExpenditure'],
  healthcareExpenditure: ['lifeExpectancy', 'gdpPerCapitaPPP', 'governmentSpending'],
  educationExpenditure: ['lifeExpectancy', 'gdpPerCapitaPPP', 'youthUnemployment'],
  urbanPopulation: ['populationGrowth', 'gdpPerCapitaPPP', 'co2Emissions'],
  youthUnemployment: ['unemploymentRates', 'educationExpenditure', 'gdpGrowth'],
  femaleLaborForce: ['laborForceParticipation', 'educationExpenditure', 'gdpGrowth'],
  laborForceParticipation: ['unemploymentRates', 'gdpGrowth', 'femaleLaborForce'],
  householdConsumption: ['gdpGrowth', 'inflationRates', 'gdpPerCapitaPPP'],
  rdSpending: ['patentApplications', 'scientificPublications', 'hightechExports'],
  internetUsers: ['mobileSubscriptions', 'gdpPerCapitaPPP', 'ictExports'],
  hightechExports: ['rdSpending', 'patentApplications', 'ictExports'],
  mobileSubscriptions: ['internetUsers', 'gdpPerCapitaPPP', 'urbanPopulation'],
  patentApplications: ['rdSpending', 'scientificPublications', 'hightechExports'],
  scientificPublications: ['rdSpending', 'patentApplications', 'educationExpenditure'],
  ictExports: ['hightechExports', 'internetUsers', 'rdSpending'],
  co2Emissions: ['energyConsumption', 'gdpPerCapitaPPP', 'renewableEnergy'],
  renewableEnergy: ['co2Emissions', 'energyConsumption', 'gdpGrowth'],
  energyConsumption: ['co2Emissions', 'renewableEnergy', 'gdpPerCapitaPPP'],
  domesticCredit: ['marketCapitalization', 'gdpGrowth', 'interestRates'],
  marketCapitalization: ['domesticCredit', 'gdpPerCapitaPPP', 'fdi'],
  privateInvestment: ['grossCapitalFormation', 'fdi', 'gdpGrowth'],
  newBusinessDensity: ['gdpGrowth', 'privateInvestment', 'internetUsers'],
  manufacturingValueAdded: ['servicesValueAdded', 'exports', 'laborProductivity'],
  servicesValueAdded: ['manufacturingValueAdded', 'gdpPerCapitaPPP', 'internetUsers'],
  agriculturalValueAdded: ['manufacturingValueAdded', 'servicesValueAdded', 'laborProductivity'],
  laborProductivity: ['gdpPerCapitaPPP', 'educationExpenditure', 'rdSpending'],
};

export function getRelatedMetrics(key: string): MetricDefinition[] {
  const related = RELATED_METRICS[key] || [];
  return related.map(k => ALL_METRICS.find(m => m.key === k)).filter(Boolean) as MetricDefinition[];
}
